...
class ComprehensiveAlertConsolidator:
    ...
    def _apply_clustering(self):
        ...
        # Check if fragmentation is high (many small groups)
        # Fragmented if: many groups (>20) with small average size (<5)
        is_fragmented = (num_graph_groups > 20 and avg_group_size < 5)
        
        if is_fragmented:
            print(f"    Groups are fragmented (many small groups)")
...
if __name__ == "__main__":
    ...
    consolidator = ComprehensiveAlertConsolidator(
        alerts_csv_path='C:/Users/jurat.shayidin/aiops/alert_data_classification_beta/alert_data.csv',  
        graph_json_path='C:/Users/jurat.shayidin/aiops/alert_data_classification_beta/graph_data.json',
        output_dir='temp'
    )
